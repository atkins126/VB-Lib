...
// Genrate case insensitive queries in SQL Server.
  ...
  KEY_TIME_SHEET = KEY_COMMON_ROOT + '\Timesheet Manager';
  KEY_TIME_SHEET_RELEASE_CFWD_MANAGER = KEY_TIME_SHEET + '\Release CFwd Manager';
  KEY_TIME_SHEET_TIMESHEET_DETAIL_REPORT = KEY_TIME_SHEET + '\Timesheet Detail Report';
